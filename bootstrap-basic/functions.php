...
if (!function_exists('bootstrapBasicEnqueueScripts')) {
    ...
    function bootstrapBasicEnqueueScripts()
    {
        ...
        wp_enqueue_style('main-style', get_template_directory_uri() . '/css/main.css');
         wp_enqueue_style('timswilson-style', get_template_directory_uri() . '/css/timswilson.css');
        wp_enqueue_style('animate-style', get_template_directory_uri() . '/css/animate.css');
        wp_enqueue_style('google-fonts', 'https://fonts.googleapis.com/css?family=Lato:300|Open+Sans');
        ...
        if (is_page(front-page) || is_page(newhomepage)){
          wp_enqueue_script('typeIt', 'https://cdn.jsdelivr.net/jquery.typeit/4.3.0/typeit.min.js','1.0',true);
          wp_enqueue_script('ScrollMagic', 'https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.5/ScrollMagic.min.js','1.0',true);
          wp_enqueue_script('font-pageJS', get_template_directory_uri() . '/js/front-page.js', array(),'1.0',true);
        }

        if (is_page(newhomepage)){
          wp_enqueue_script('addIndicators', 'https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.5/plugins/debug.addIndicators.min.js','1.0',true);
        }
